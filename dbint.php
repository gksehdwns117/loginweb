...
$databaseName = 'userdb';
$databaseUser = 'root';
$databasePassword = 'qkrtjswjd1807n@';


/*
 * 데이터베이스 생성
 */
$pdoDatabase = new PDO('mysql:host=192.168.10.4', $databaseUser, $databasePassword);
 ...
 * 테이블 생성
 */
$pdo = new PDO('mysql:host=192.168.10.4;dbname='.$databaseName, $databaseUser, $databasePassword);
